"""
LotusAI managers/messaging.py - Messaging Manager
...
- Temizlenmiş ve optimize edilmiş mimari
"""
...
class MessagingManager:
    ...
    def __init__(self, access_level: Optional[str] = None):
        ...
        # Config (Artık doğrudan merkezi yapılandırmadan okuyoruz)
        self.access_token = Config.META_ACCESS_TOKEN or ""
        self.wa_phone_id = Config.WHATSAPP_PHONE_ID or ""
        self.ig_account_id = Config.INSTAGRAM_ACCOUNT_ID or ""
        self.fb_page_id = Config.FACEBOOK_PAGE_ID or ""
        self.app_secret = Config.META_APP_SECRET or ""
        ...
        self.is_active = bool(
            ...
            (self.wa_phone_id or self.ig_account_id or self.fb_page_id)
        )
        ...
        if not self.is_active:
            ...
            logger.info(f"✅ API MODU AKTİF (Erişim: {self.access_level.upper()})")
